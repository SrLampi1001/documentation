...
### Overview
- **Project name**
- **Riwi module** (if applicable)
- **Short description**
- **Status**
- **Languages**
### Folder Structure
A tree diagram to show the organization of files. Example:
```
project-root/
├── src/
│   ├── components/
...
- **Coding standars**
  - Most projects use camelCase

### Instalation & Setup
- **Prerequisites**
  - Most projects need Node.js
- **Step-by-step setup commands**
- **Enviroment variables or configuration files**
### Usage
- **How to run the project locally**
- **Example commands or scripts**
- **Screeshots or sample outputs**

### Testing
- **Framework used** 
  - As of currently, there are no tests made in any projects
- **How to run tests**
- **Expected coverage or reporting**

### Deployment
- **Hosting platform**
  - Most projects are being hosted in GitHub Pages
- **CI/CD pipeline details**
  - As of currently, there are no pipeline employed for any project
